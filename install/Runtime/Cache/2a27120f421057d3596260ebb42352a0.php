...
<div class="c_main fr">
<form action="<?php echo u('Index/check');?>" method="POST" id="post_form">
	<div class="c_main_title"><span class="fr padding5">Powered by(phonegap100.com)</span><?php echo (L("step_check_desc")); ?></div>
    ...
    <div class="act">
        <div class="btn">
            ...
            <?php else: ?>
            <input type="submit" name="dosubmit" id="submit_button"  value="<?php echo (L("next")); ?>" class="btn_next" /><?php endif; ?>
        </div>
    </div>
</form>
</div>
