...
<form action="" method="POST" id="post_form">
	<div class="c_main_title"><span class="fr padding5">Powered by(phonegap100.com)</span><?php echo (L("step_eula_desc")); ?></div>
	<div class="c_main_body eula">
    	<?php if(isset($error_msg)): ?><div class="error_msg"><?php echo ($error_msg); ?></div><?php endif; ?>
    	<?php echo ($eula_html); ?>
    </div>
    <div class="act">
    	<div class="accept"><input type="checkbox" name="accept" id="accept" class="input_checkbox" value="1" />&nbsp;&nbsp;<label for="accept"><?php echo (L("i_accept")); ?></label></div>
