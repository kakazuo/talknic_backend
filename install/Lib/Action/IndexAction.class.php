...
class IndexAction extends Action
{
	...
	public function setconf()
	{
		...
		$this->assign('db_name', 'mobilecms');
		$this->assign('db_prefix', 'talknic_');
	...
	public function show_process()
	{
		...
		$sqls = $this->_get_sql(APP_PATH . '/Sql_data/talknic.sql');	
		foreach ($sqls as $sql) {
			//替换前缀
			$sql = str_replace('`cms_', '`'.$temp_info['db_prefix'], $sql);			
			//获得表名
